...
"""
    ...
    def add_task_to_queue(self, task_data):
        ...
        try:
            ...
            logger.info(f"Task {task_data['task_id']} added to queue")
        except Exception as e:
            logger.error(f"Failed to add task to queue: {e}")

def main():
    """Main worker function - continuously process tasks from queue"""
    logger.info("Starting Lecture Notes Worker")
